    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invite', models.ForeignKey(related_name='memberships', verbose_name='invite', blank=True, to='invitations.JoinInvitation', null=True)),
            ],
            options={
                'verbose_name': 'Team',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(related_name='teams_created', verbose_name='creator', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Team',
                'verbose_name_plural': 'Teams',
        ...
        migrations.AddField(
            ...
            name='team',
            field=models.ForeignKey(related_name='memberships', verbose_name='team', to='teams.Team'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='membership',
            name='user',
            field=models.ForeignKey(related_name='memberships', verbose_name='user', blank=True, to=settings.AUTH_USER_MODEL, null=True),
            preserve_default=True,
        ),
